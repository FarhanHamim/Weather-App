...
class _LoadingScreenState extends State<LoadingScreen> {
  ...
  Future<dynamic> getCityWeather(String cityName) async {
    final apiKey = 'b001c2c7b8d3b0dd8d4b3a6c419c2daf';

    //A default city ("Dhaka" in this case)
    String city = cityName.isEmpty ? "Dhaka" : cityName;

    final weatherUrl = 'https://api.openweathermap.org/data/2.5/weather?q=$city&appid=$apiKey&units=metric';
